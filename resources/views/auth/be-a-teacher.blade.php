    ...
    <div class="register-box">
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="{{ route('be.a.teacher')}} " method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="input-group mb-3"> 
                        <label class="input-group-text" for="file">ID</label>
                        <x-input type="file" :invalid="$errors->has('file_path') ? 'is-invalid' : ''"
                            name="file_path" 
                            id="file"
                            required />
                        <div class="input-group-text"> 
